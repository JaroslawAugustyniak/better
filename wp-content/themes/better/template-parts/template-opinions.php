...
<section class="homepage-section opinions section <?=$bg?>" data-waypoint-header="<?=get_header_color($bg)?>">
        <div class="container">
            ...
            <div class="comments-carousel-container" data-waypoint-animate="true">
                    ...
                    <div id="commentsCarousel" auto_play="1" speed="6000" data-waypoint-animate="true"  class="comments-carousel slickSlider display_dots slick_nav nav_inside" slick_per_page="3_3_3_1" slick_show_dots="0" slick_hide_arrows="0" fade="0"> 
